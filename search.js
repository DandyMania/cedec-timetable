...
const COMPANY_SEED = [
  ...
  ['リアリティ', 'reality'],
  ['ミライセンス', 'miraisens'],
  ['コーテク', 'コエテク', 'コーエーテクモ', 'コーエーテクモゲームス', 'koei tecmo'],
  ['フロム', 'フロムソフトウェア', 'from software', 'fromsoftware'],
  ['コジプロ', 'コジマプロダクション', 'kojima productions'],
  ['アークシス', 'アークシステムワークス', 'arc system works'],
  ['ヘキサ', 'ヘキサドライブ', 'hexadrive'],
  ['クリーチャーズ', 'creatures'],
  ['ガンバリオン', 'ganbarion'],
  ['クオリアーツ', 'qualiarts'],
  ['エイミング', 'aiming'],
  ['カラパレ', 'カラフルパレット', 'colorful palette'],
  ['シーアールアイ', 'cri', 'cri ミドルウェア'],
  ['エニカラ', 'anycolor', 'にじさんじ'],
  ['クラスター', 'cluster'],
  ['アプリボット', 'applibot'],
  ['オルトプラス', 'altplus'],
  ...
  ['ノイジークローク', 'noisycroak'],
  ['セガサミー', 'sega sammy'],
  ['バンナムエンタメ', 'バンダイナムコエンターテインメント', 'バンダイナムコエンターテイメント'],
  ['ソニーグループ', 'ソニー'],
  ['テンセント', 'tencent'],
  ['ユービーアイ', 'ubisoft'],
  ['パールアビス', 'pearl abyss'],
  ['ネットイース', 'netease', '網易'],
  ['サイバーコネクト', 'サイバーコネクトツー', 'cc2'],
  ['ヘッドハイ', 'head high'],
  ['ボンデジ', 'ボーンデジタル', 'borndigital'],
  ['クリリバ', 'クリークアンドリバー', 'creek and river'],
  ['シリスタ', 'シリコンスタジオ', 'silicon studio'],
  ['ノイクロ', 'ノイジークローク'],
  ['トラゼタ', 'トライゼット'],
  ['カヤック', 'kayac'],
  ['ミラクルアーツ'],
